...
```
## Output
<img width="818" height="255" alt="image" src="https://github.com/user-attachments/assets/c00284fd-9569-4b32-b0dc-707b09e0e404" />

## Result
Thus, the average number of materials and waiting time in the system and conveyors were calculated successfully using the Open Jackson Network model.
